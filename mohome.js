...
// Bhanu
fa("#bhanushree", "#profile-mo-1");
fr("#close-bhanu", "#profile-mo-1");

// rajamma
fa("#rajamma", "#profile-mo-2");
fr("#close-raja", "#profile-mo-2");

// rajamma
fa("#harish", "#profile-mo-3");
fr("#close-harish", "#profile-mo-3");
